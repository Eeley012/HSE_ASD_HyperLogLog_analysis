...
RandomStreamGen - генерирует поток случайных строк

HyperLogLog - реализация одноименного алгоритма

HyperLogLogMax - модификация HyperLogLog с использованием std::bitset
